...
export const getERC20 = (address: string, web3?: Web3): Web3Contract => {
	return getWeb3Contract(address, ABIS.ERC20, web3);
}

export const getBentMasterChef = (address: string, web3?: Web3): Web3Contract => {
	return getWeb3Contract(address, ABIS.BentMasterChef, web3);
}

export const getSushiPairContract = (address: string, web3?: Web3): Web3Contract => {
	return getWeb3Contract(address, ABIS.SushiPair, web3);
}

export const getCvxBaseRewardPool = (address: string, web3?: Web3): Web3Contract => {
