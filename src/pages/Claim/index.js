...
import {
  ...
  Row,
  Col,
  TabContent, TabPane, Nav, NavItem, NavLink, Card,  CardTitle, CardText, Table, Input, Label, CardBody, 
            ...
            <div className="autoText">
                <div className="advance-btn">
                    <Label className="switch"> 
                        <Input type="checkbox" value={autoText} name="checkbox" onChange={handleAutoActiveStatus}/>
                        ...
                        <Col lg="6">
                            <div className="numberCheck">
                                <Label className="contain">
                                    <Input type="radio" onChange={() => handleStakeStus('none')} checked={stakeStatus==='none'} name="radio" />
                                    <span className="checkmark"></span>
                                    <span className="checkText">None</span>
                                </Label>
                                <Label className="contain">
                                    <Input type="radio" onChange={() => handleStakeStus('crv')} checked={stakeStatus==='crv'} name="radio" />
                                    <span className="checkmark"></span>
                                    <span className="checkText">CRV</span>
                                </Label>
                                <Label className="contain">CVX
                                    <Input type="radio" onChange={() => handleStakeStus('cvx')} checked={stakeStatus==='cvx'} name="radio" />
                                    <span className="checkmark"></span>
                                    <span className="checkText">CVX</span>
                                </Label>
                                <Label className="contain">
                                    <Input type="radio" onChange={() => handleStakeStus('both')} checked={stakeStatus==='both'} name="radio" />
                                    <span className="checkmark"></span>
            ...
            <Container>
              <div className="cliamBox">
                ...
                <div className="table-Responsive">
                  ...
                  <Button className="bentPool" color="primary" id="toggler" style={{ marginBottom: '1rem' }}>
                    <Row className="align-items-center">
                     ...
                     <UncontrolledCollapse toggler="#toggler" className="bentpoolText">
                  <Card>
                      <CardBody>
                         ...
                         <div className="innerWrap">
                          <Button className="bentInner" color="primary" id="togglerInner" style={{ marginBottom: '1rem' }}>
                            <Row className="align-items-center">
                              <Col>
                                <div className="imgText">
                                  <img src={UsdIcon} alt="" />
                              ...
                              <UncontrolledCollapse className="innerAccordian" toggler="#togglerInner">
                                <Card>
                                  <CardBody>
                                    <Row className="align-items-center">
                                      <Col sm={12}>
              ...
              <div className="table-Responsive">
                    <div className="table-Wrapper">
                    <div className="toggleWrap">
                  <Button className="bentPool" color="primary" id="togglerSecond" style={{ marginBottom: '1rem' }}>
                    <Row className="align-items-center">
                      <Col>
                          <div className="imgText">
                              <img src={CrvIcon} alt="" />
                     ...
                     <UncontrolledCollapse toggler="#togglerSecond" className="bentpoolText">
                  <Card>
                      <CardBody>
              ...
              <div className="cliamBlockOne">
                <div className="table-Responsive">
                  <div className="table-Wrapper">
                    <div className="toggleWrap">
                  <Button className="bentPool" color="primary" id="togglerThird" style={{ marginBottom: '1rem' }}>
                    <Row className="align-items-center">
                      <Col>
                          <div className="imgText">
                              <img src={CrvIcon} alt="" />
                     ...
                     <UncontrolledCollapse toggler="#togglerThird" className="bentpoolText">
                  <Card>
                      <CardBody>
                ...
                <div className="table-Responsive">
                    <div className="table-Wrapper">
                    <div className="toggleWrap">
                  <Button className="bentPool" color="primary" id="togglerFourth" style={{ marginBottom: '1rem' }}>
                    <Row className="align-items-center">
                      <Col>
                          <div className="imgText">
                     ...
                     <UncontrolledCollapse toggler="#togglerFourth" className="bentpoolText">
                  <Card>
                      <CardBody>
                ...
                <div className="table-Responsive">
                    <div className="table-Wrapper">
                    <div className="toggleWrap">
                  <Button className="bentPool" color="primary" id="togglerFifth" style={{ marginBottom: '1rem' }}>
                    <Row className="align-items-center">
                      <Col>
                          <div className="imgText">
                     ...
                     <UncontrolledCollapse toggler="#togglerFifth" className="bentpoolText">
                        <Card>
                            <CardBody>
                                ...
                                <div className="innerWrapother">
                                    <div className="bentInnertext" color="primary">
                                        <Row className="align-items-center">
                                          <Col sm={12}>
                                            <p className="epsText">The EPS airdrop is an initiative of the Ellipsis platform, running on
                                              Binance Smart Chain (BSC), to offer part of its governance and revenue 
                                              flow to Curve ecosystem stakeholders. You’re part of these stakeholders
                                                when you stake cvxCRV tokens on Convex. Every week, EPS tokens are airdropped to 
                                                all cvxCRV stakers, and can be claimed below. Since Ellipsis is running on 
                                                Binance Smart Chain, you need to connect to the BSC network in order to claim this airdrop.</p>
                                        ...
                                        <Col>
                                          ...
                                          <div className="imgOverText Active">
                                              <img className="starIcon" src={starActive} alt="" />
                                                <div className="textlayer">
                                                    <h6>Week 1</h6>
                                                    <h4>Nothing to claim</h4>
                                                </div>  
